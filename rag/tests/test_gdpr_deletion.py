...
class TestDocumentDeletion:
    ...
    def test_delete_document_returns_200(
        ...
        with (
            patch("app.services.vectorstore.get_vectorstore_service") as mock_vs,
            patch("app.services.documents.get_document_service") as mock_ds,
        ):
...
class TestUserDeletion:
    ...
    def test_delete_user_data_returns_200(
        ...
        with patch("app.services.vectorstore.get_vectorstore_service") as mock_vs:
            mock_vectorstore = MagicMock()
